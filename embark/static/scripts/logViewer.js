...
function onLoad() {
   ...
   function onMessage(evt) {
      ...
      if (message.file_view) {
         fileContent = atob(message.file_view.content) + '\u00a0' // The nbsp is required in order to preserve trailing newlines
   ...
   function requestUpdate() {
      request_view = Object.assign({}, file_view)
      request_view.content = ''
      socket.send(JSON.stringify({ 'action': 'change_view', 'file_view': request_view }));
   }
