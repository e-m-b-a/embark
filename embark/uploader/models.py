...
class Firmware(models.Model):
    ...
    deep_extraction = models.BooleanField(help_text='Enable deep extraction - try to extract every file two times with binwalk, -x will be added', default=False)
    log_path = models.BooleanField(help_text='Ignores log path check, -i will be added', default=False)
    grep_able_log = models.BooleanField(help_text='Create grep-able log file in [log_path]/fw_grep.log, -g will be added', default=False)
    relative_paths = models.BooleanField(help_text='Prints only relative paths, -s will be added', default=False)
    ...
    emulation_test = models.BooleanField(help_text='Enables automated qemu emulation tests (WARNING this module could harm your host!), -E will be added')
