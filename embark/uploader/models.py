...
class Firmware(models.Model):
    ...
    title = models.CharField(help_text='', blank=True, max_length=MAX_LENGTH)

    version = models.CharField(help_text='Firmware version (double quote your input)', verbose_name=u"Firmware version",
                               max_length=MAX_LENGTH)
    vendor = models.CharField(help_text='Firmware vendor (double quote your input)', verbose_name=u"Firmware vendor",
                              max_length=MAX_LENGTH)
    device = models.CharField(help_text='Device (double quote your input)', verbose_name=u"Device",
                              max_length=MAX_LENGTH)
    notes = models.CharField(help_text='Testing notes (double quote your input)', verbose_name=u"Testing notes",
                             max_length=MAX_LENGTH)

    firmware_Architecture = models.CharField(choices=[('MIPS', 'MIPS'), ('ARM', 'ARM'), ('x86', 'x86'), ('x64', 'x64'),
                                                      ('PPC', 'PPC')],
                                             verbose_name=u"Select architecture of the linux firmware",
                                             help_text='Architecture of the linux firmware [MIPS, ARM, x86, x64, PPC],'
                                                       ' -a will be added', max_length=MAX_LENGTH, blank=True)
    ...
    docker_container = BooleanFieldExpertMode(help_text='Run emba in docker container, -D will be added', default=False,
    ...
    log_path = BooleanFieldExpertMode(help_text='Ignores log path check, -i will be added', default=True,
                                      expert_mode=True, blank=True)
    ...
    ANSI_color = BooleanFieldExpertMode(help_text='Adds ANSI color codes to log, -z will be added', default=False,
                                        expert_mode=True, blank=True)
