    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firmware_Architecture', uploader.models.CharFieldExpertMode(blank=True, choices=[(None, 'Select architecture'), ('MIPS', 'MIPS'), ('MIPS64R2', 'MIPS64R2'), ('MIPS64_III', 'MIPS64_III'), ('MIPS64_N32', 'MIPS64_N32'), ('ARM', 'ARM'), ('ARM64', 'ARM64'), ('x86', 'x86'), ('x64', 'x64'), ('PPC', 'PPC'), ('PPC64', 'PPC64'), ('NIOS2', 'NIOS2'), ('RISCV', 'RISCV'), ('QCOM_DSP6', 'QCOM_DSP6')], help_text='Architecture of the linux firmware [MIPS, ARM, x86, x64, PPC, NIOS2] -a will be added (note: other options are not in use yet)', max_length=127, verbose_name='Select architecture of the linux firmware')),
                ...
                ('scan_modules', models.JSONField(blank=True, default=uploader.models.scan_modules_default_value, null=True)),
                ('path_to_logs', models.FilePathField(blank=True, default='/')),
                ('log_size', models.PositiveBigIntegerField(blank=True, default=0)),
                ...
                ('status', models.JSONField(default=uploader.models.jsonfield_default_value)),
            ],
        ),
        migrations.CreateModel(
            name='FirmwareFile',
