...
class LogReader:
    ...
    def read_loop(self):
       ...
       """
        ...
        while not self.finish:
            ...
            pat = f"{settings.EMBA_ROOT}{settings.LOG_ROOT}/emba_new_{self.firmware_id}.log"
    ...
    def copy_file_content(self, diff):
        ...
        with open(f"{settings.EMBA_ROOT}{settings.LOG_ROOT}/emba_new_{self.firmware_id}.log", 'a+', encoding='utf-8') as diff_file:
    ...
    def get_diff(self, log_path):
        ...
        with open(f"{log_path}/emba.log", encoding='utf-8') as old_file, open(f"{settings.EMBA_ROOT}{settings.LOG_ROOT}/emba_new_{self.firmware_id}.log", encoding='utf-8') as new_file:
