...
HASHID_FIELD_SALT = env('HASHID_SALT')
HASHID_FIELD_MIN_LENGTH = env.int('HASHID_FIELD_MIN_LENGTH', 7)
HASHID_FIELD_ENABLE_HASHID_OBJECT = env.bool('HASHID_FIELD_ENABLE_HASHID_OBJECT', False)
HASHID_FIELD_ENABLE_DESCRIPTOR = env.bool('HASHID_FIELD_ENABLE_DESCRIPTOR', False)
SECRET_KEY = env('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = bool(env.bool('EMBARK_DEBUG', True))
...
LOG_LEVEL = env.str('DJANGO_LOG_LEVEL', 'DEBUG').upper()
LOGGING = {
    'version': 1,
