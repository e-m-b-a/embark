...
WORKER_SETUP_PATH = os.path.join(WORKER_FILES_PATH, "WORKER_SETUP")
WORKER_SETUP_ZIP_PATH = os.path.join(WORKER_FILES_PATH, "WORKER_SETUP.tar.gz")
WORKER_SETUP_LOGS = os.path.join(WORKER_FILES_PATH, "worker_setup.log")
